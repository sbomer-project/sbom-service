...
/**
 * Represents a single execution attempt of a Generation in the background worker.
...
public class GenerationRunEntity extends PanacheEntityBase {
    ...
    @JoinColumn(name = "generation_db_id", nullable = false)
     ...
     */
    @Enumerated(EnumType.STRING)
    private GenerationResult reason;
