...
public class MapperTest {
    ...
    void testRequestRecord() {
        ...
        assertThat(requestEntity.getGenerations().get(0).getId()).isEqualTo(generationId);
        ...
        assertThat(statusMapperDto.getGenerationRecords().get(0).getId()).isEqualTo(generationId);
    }
    ...
    void testGenerationRecord() {
        ...
        generationRecord.setGenerationSbomUrls(List.of("url1", "url2"));
        ...
        assertThat(generationEntity.getEnhancements().get(0).getId()).isEqualTo(enhancementId);
        assertThat(generationEntity.getGenerationSbomUrls()).containsExactly("url1", "url2");
        ...
        assertThat(generationMapperDto.getEnhancements().get(0).getId()).isEqualTo(enhancementId);
        assertThat(generationMapperDto.getGenerationSbomUrls()).containsExactly("url1", "url2");
    }
    ...
    void testEnhancementRecord() {
        ...
        String generationId = UUID.randomUUID().toString();
        enhancementRecord.setGenerationId(generationId);
        enhancementRecord.setEnhancedSbomUrls(List.of("url1", "url2"));
        ...
        assertThat(enhancementEntity.getEnhancedSbomUrls()).containsExactly("url1", "url2");
        ...
        assertThat(enhancementMapperDto.getEnhancedSbomUrls()).containsExactly("url1", "url2");
    }
}
